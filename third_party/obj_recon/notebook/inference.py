...
import obj_recon_core  # REMARK(Pierre) : do not remove this import
from obj_recon_core.pipeline.inference_pipeline_pointmap import InferencePipelinePointMap
from obj_recon_core.model.backbone.tdfy_dit.utils import render_utils

from obj_recon_core.utils.visualization import SceneVisualizer

__all__ = ["Inference"]

WHITELIST_FILTERS = [
    lambda target: target.split(".", 1)[0] in {"obj_recon_core", "torch", "torchvision", "moge"},
]
