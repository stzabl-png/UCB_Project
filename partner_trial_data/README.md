...
| folder | object | DexYCB subject | DexYCB session | n_steps | sim mass for replay |
|---|---|---|---|---|---|
| `sugar_box_ycb_dex_03/`       | YCB 004 sugar box     | `20200709-subject-01` | `20200709_142517` | 34 | **0.2 kg** (override; real is 0.514 kg, but at that mass the retarget grasp doesn't reliably lift) |
| `mustard_bottle_ycb_dex_05/`  | YCB 006 mustard bottle | `20200709-subject-01` | `20200709_143211` | 34 | **0.603 kg** (real YCB mass; default in `grasp_physics.object_mass_kg(5)`) |
...
* Source episode files (these `trajectory.hdf5` files are byte-identical copies):
  `Baseline1/data/episodes_g/dexycb__20200709-subject-01__20200709_142517__840412060917__ycb_dex_03.hdf5`
  `Baseline1/data/episodes_g/dexycb__20200709-subject-01__20200709_143211__840412060917__ycb_dex_05.hdf5`
* Reference successful-grasp sim videos:
  `replay_video_check/gtreplay_grasp_sugar_0p2kg.mp4`     (sugar, `--object-mass 0.2`)
  `replay_video_check/gtreplay_grasp_mustard_realmass.mp4` (mustard, default real mass)
* Retarget pipeline entry:  `Baseline1/build_gt_replay.py`
* Sim replay driver:        `sim/gt_replay_ikpd_v2.py`
* Reference batch wrapper:  `sim/run_gt_replay_grasp.sh`
* Multi-angle paper-figure replays:
  `sim/multi_angle_replay.sh` → `tem_replay_video_and_frames/`
