...
- `demo/SIM2REAL_PLAN.md`: sim-to-real implementation plan (Dexmate Vega + SharpaWave-as-virtual-2-finger).
- `demo/pipeline/`: auto demo pipeline on Titan (`python -m demo.pipeline`).
