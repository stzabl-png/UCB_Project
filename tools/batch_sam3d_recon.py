...
用法:
    ...
    conda run -n sam3d-objects python tools/batch_sam3d_recon.py
...
SAM3D_ROOT = f"{PROJ}/third_party/sam-3d-objects"
sys.path.insert(0, f"{SAM3D_ROOT}/notebook")

INPUT_BASE = f"{PROJ}/data_hub/ProcessedData/obj_recon_input"
OUTPUT_BASE = f"{PROJ}/data_hub/ProcessedData/obj_meshes"
LOG_PATH = f"{PROJ}/output/sam3d_batch_log.jsonl"
EGODEX_RAW_BASE = f"{PROJ}/data_hub/RawData/EgoRawData/egodex/test"
