...
def try_strategy_a_candidate(
    ...
    *,
    ...
    grasp_point, approach, finger_dir, R_pert = _perturb_anchor_pose(
        ...
        max_approach_trans_m=max_approach_jitter_mm / 1000.0,
    )
...
def generate_anchored_candidates(
    ...
    *,
    ...
    max_tip_jitter_mm: float = 8.0,
    max_approach_jitter_mm: float = 1.0,
    ...
    meta: dict[str, Any] = {
        ...
        "perturb": {
            ...
            "max_approach_jitter_mm": max_approach_jitter_mm,
        },
