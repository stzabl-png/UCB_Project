...
from env_config.utils.Set_Drive import set_drive
from env_config.utils.Transforms import quat_diff_rad, Rotation, get_pose_relat, get_pose_world
from env_config.utils.Code_Tools import float_truncate, dense_trajectory_points_generation
...
class Franka(Robot):
    def __init__(
        ...
        # get Franka usd file
        self.asset_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../assets_franka/franka.usd")
