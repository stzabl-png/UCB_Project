#!/bin/bash
# ============================================================
# run_sim_titan_gpu0.sh  —  TitanX GPU 0: OakInk Sim 抓取
# ============================================================
# 在 TitanX 服务器上执行:
#   CUDA_VISIBLE_DEVICES=0 bash scripts/run_sim_titan_gpu0.sh
# ============================================================
...
GRASP_DIR="${GRASP_DIR:-$PROJ/output/grasps_candidate}"
GT_DIR="${GT_DIR:-$PROJ/output/robot_gt_oakink}"
LOG_DIR="${LOG_DIR:-$PROJ/output/sim_logs_oakink}"
...
echo ""
echo "============================================================"
echo "  GPU 0 OakInk 完成: ✅$SUCCESS  ❌$FAILED  ⏭️$SKIPPED / $TOTAL"
echo "  结束时间: $(date)"
echo "  结果: $GT_DIR"
echo "============================================================"
